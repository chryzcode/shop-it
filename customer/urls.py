...
urlpatterns = [
    ...
    path("logout/<slugified_store_name>/", views.customer_logout, name="customer_logout"),
    ...
    path("add-wishlist/<slug>", views.customer_add_wishlist, name="customer_add_wishlist"),
    path("remove-wishlist/<slug>", views.customer_remove_wishlist, name="customer_remove_wishlist"),
